...
namespace TarjetaSubeTest
{
    ...
    public class FranquiciaHorarioTest
    {
        ...
        [Test]
        public void BoletoGratuito_VerificaHorario()
        {
            TarjetaBoletoGratuito gratuito = new TarjetaBoletoGratuito();
            DateTime ahora = DateTime.Now;
            
            bool resultado = gratuito.PuedeViajarEnEsteHorario();
            
            // verificar consistencia basica
            bool esFinDeSemana = (ahora.DayOfWeek == DayOfWeek.Saturday || 
                                  ahora.DayOfWeek == DayOfWeek.Sunday);
            bool esFueraDeHorario = (ahora.Hour < 6 || ahora.Hour >= 22);
            
            if (esFinDeSemana || esFueraDeHorario)
            {
                Assert.IsFalse(resultado);
            }
        }
        ...
        [Test]
        public void Colectivo_BoletoGratuito_NoPermitePagoFueraHorario()
        {
            TarjetaBoletoGratuito gratuito = new TarjetaBoletoGratuito();
        ...
        public void MetodosPuedeViajar_DevuelvenBooleano()
        {
            ...
            Assert.IsInstanceOf<bool>(gratuito.PuedeViajarEnEsteHorario());
